...
class ModuleManager(object):
    def __init__(self, *args, **kwargs):
        ...
        self.endpoint_id = self.module.params.get('endpoint_id', None)
    ...
    def exec_module(self):
        ...
        if self.endpoint_id in self.parse_subscriptions: self.parse_subscriptions.pop(self.endpoint_id)
...
class ArgumentSpec(object):
    def __init__(self):
        ...
        argument_spec = dict(
            ...
            endpoint_id=dict(required=True),
        )
        self.argument_spec = {}
